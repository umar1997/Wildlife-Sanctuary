		   ...
		   if($_POST){
			   if($_POST['staff_id'] == ''){
				   ...
				   if(mysqli_num_rows($result) > 0){
					   $warning="This staff member is aleady registered";
				   }else{
				   $query="insert into `staff` values('".$_POST['staff_id']."','".$_POST['staff_name']."','".$_POST['occupation']."',".$_POST['salary'].")";
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="staff_name" class="form-control" id="inputPassword">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="occupation" class="form-control" id="inputPassword">
    </div>
  </div>
...
<div class="form-group row">
 ...
 <a href="viewstaff.php"><button type="button" class="btn btn-success">View List</button></a>        
</form>
     </div>    
       <br>
 <div class="container">
          <a href="staffup.php"><button type="button" class="btn btn-success">Update</button></a>
        
    
        <a href="staffdel.php"><button type="button" class="btn btn-danger">Delete</button></a>
