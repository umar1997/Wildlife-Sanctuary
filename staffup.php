<?php
	...
	if($_POST){
		if($_POST['staff_id']){
			...
			if($_POST['occupation'] AND $_POST['salary']){
				$query="update `staff` set occupation='".$_POST['occupation']."',salary='".$_POST['salary']."' where staff_id='".$_POST['staff_id']."'";
				mysqli_query($link,$query);
				$success="Updated successfully";
			}else if($_POST['occupation']){
				$query="update `staff` set occupation='".$_POST['occupation']."' where staff_id='".$_POST['staff_id']."'";
				mysqli_query($link,$query);
				$success="Updated successfully";
			}else if($_POST['salary']){
				$query="update `staff` set salary='".$_POST['salary']."' where staff_id='".$_POST['staff_id']."'";
				mysqli_query($link,$query);
				$success="Updated successfully";
			}
			else if($_POST['occupation']=='' AND $_POST['salary']==''){
					$warning="Please enter the changes";
			}
			   }else{
				    $error="You didn't entered the valid Staff Id";
			   }
		}else{
			$error="You didn't entered the staff id";
		}
	}
...
<html lang="en">
 ...
 <div><?php
  ...
  <div class="form-group row">
    <label for="text" class="col-sm-2 col-form-label">Occupation</label>
    <div class="col-sm-10">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title4"><a href="stats.html" style="color: #000066;">Statistics</a></h5>
      <p class="card-text"></p>
      <p class="card-text"><small class="text-muted"></small></p>
    </div>
  </div> 
